...
def get_args():
    ...
    # some args
    parser.add_argument('--exp_name', type=str, default='ModelNet40_Test', help='experiment name')
    ...
    parser.add_argument('--ckpts', type=str, default=None,
                        help='test used ckpt path') #"../../../pretrainedmodels/PointMamba/pretrain.pth"
    ...
    parser.add_argument('--test', action='store_true', default=False, help='test mode for certain ckpt') #True False
